...
export const WarningScreen: React.FC<WarningScreenProps> = ({ onContinue, onBack }) => {
  ...
  function ExportWalletButton() {
    ...
    return (
      <button 
        onClick={() => {exportWallet(); onBack()}} 
        disabled={!isAuthenticated || !hasEmbeddedWallet || !acknowledged}
      ...
      >
        <span className="font-bold">Continue</span> & Press <span className="font-bold">Copy Key</span>
      </button>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <h1 className="text-xl font-semibold text-white">Show Private Key</h1>
        <button
          onClick={onBack}
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold text-white">Keep Your Private Key Secret</h2>
      </div>

      {/* Warning Points */}
      <div className="space-y-4 mb-6">
        <div className="flex items-start gap-3">
          <div className="w-6 h-6 bg-amber-500/20 border border-amber-500/30 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
